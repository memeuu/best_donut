...
async function getWeeklyPlan(){
	const response = await fetch("/ajax/weeklyPlan");
...
async function beforeInsertInsCode(){
    const response = await fetch("/ajax/beforeInsertInsCode");
    const res = await response.json();
...
async function insertInstruct() {
	...
	const response = await fetch('ajax/insertProdInstruct', {
		method: 'post',
		headers: jsonHeaders,
...
async function getEqmOpr(){
	const response = await fetch("/ajax/procEqmInfo");
	const res = await response.json();
...
async function getEqmAll(serachEqmName){
	const response = await fetch(`/ajax/eqmAllInfo?eqmName=${serachEqmName}`);
	const res = await response.json();
...
async function updateProcEqm() {
	...
	const response = await fetch('ajax/updateProcEqm', {
		method: 'post',
		headers: jsonHeaders,
